            ...
            {NAV.map((n) => (
              <button
                ...
                style={{
                  ...
                  marginBottom: 4,
                  background:
                    screen === n.key ? "var(--tag-bg)" : "transparent",
        ...
        {!isDesktop && (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span
                style={{ fontWeight: 800, fontSize: 20, color: "var(--logo)" }}
              >
                아이랑
              </span>
            </div>
        ...
        <div style={{ flex: 1, overflow: "hidden", position: "relative" }}>
          ...
          >
            <HomeScreen
              ...
              onAddTrip={handleSaveTrip}
              savedTrips={savedTrips}
            />
          </div>
          <div
            style={{
              display: screen === "search" ? "block" : "none",
              height: "100%",
            }}
          >
          ...
          <div
            style={{
              display: screen === "bundle" ? "block" : "none",
              height: "100%",
            }}
          >
            <BundleMakerScreen
          ...
          <div
            style={{
              display: screen === "trips" ? "block" : "none",
              height: "100%",
            }}
          >
            <TripsScreen
          ...
          <div
            style={{
              display: screen === "settings" ? "block" : "none",
              height: "100%",
            }}
          >
